...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/sylvia/PycharmProjects/djangoregistration/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/home/sylvia/PycharmProjects/djangoregistration/venv/bin/deactivate.nu'
